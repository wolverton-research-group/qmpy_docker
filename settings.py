...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('qmdbname'),
        'USER': os.environ.get('qmdbuser'),
        'PASSWORD': os.environ.get('qmdbpassword'),
        'HOST': os.environ.get('qmdbhost'),
        'PORT': os.environ.get('qmdbport') 
    }
}
